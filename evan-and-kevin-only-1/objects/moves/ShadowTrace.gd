class_name ShadowTraceMove extends BaseMove
...
func _init() -> void:
	...
	deals_damage = true
	kills_user = false
	move_name = "Shadow Trace"
	move_animation = "Melee"
	descr = "If foe prepares an attack, goes first and flinches foe. Otherwise, it fails and user loses 50% Health."
